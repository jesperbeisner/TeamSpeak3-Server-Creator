 ...
 */
final class Version20220509053019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, server_port INTEGER NOT NULL, container_created DATETIME NOT NULL, container_removed DATETIME NOT NULL)');
        ...
        $this->addSql('CREATE TABLE start (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, server_port INTEGER NOT NULL, created DATETIME NOT NULL)');
    }
